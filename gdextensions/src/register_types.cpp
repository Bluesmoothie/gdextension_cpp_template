...
void initialize_my_module(ModuleInitializationLevel p_level)
{
	...
	GDREGISTER_RUNTIME_CLASS(GDExt);
}
...
extern "C"
{
	GDExtensionBool GDE_EXPORT my_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization)
	{
